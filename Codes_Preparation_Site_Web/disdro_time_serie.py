...
mat = []
print(today)
fichier1 = open("/stationuqam/disdrometre/Parsivel_UQAM_"+str(today.year)+('%02d' % today.month)+('%02d' % today.day)+".dat","r") 
...
resultD.to_csv('/NFS2_RESCUE2/stationuqam/programmes/preparation_donnees_station/data/Timeserie_Diametre.csv')
...
resultV.to_csv('/NFS2_RESCUE2/stationuqam/programmes/preparation_donnees_station/data/Timeserie_Vitesse.csv')
